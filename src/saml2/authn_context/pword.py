...
class PasswordType_(SamlBase):
    ...
    c_children["{urn:oasis:names:tc:SAML:2.0:ac:classes:Password}Generation"] = (
        "generation",
        Generation,
    )
...
class TokenType_(SamlBase):
    ...
    c_child_order = SamlBase.c_child_order[:]
    c_cardinality = SamlBase.c_cardinality.copy()
    c_children["{urn:oasis:names:tc:SAML:2.0:ac:classes:Password}TimeSyncToken"] = (
        "time_sync_token",
        TimeSyncToken,
    )
    c_children["{urn:oasis:names:tc:SAML:2.0:ac:classes:Password}Extension"] = (
...
class IdentificationType_(SamlBase):
    ...
    c_children["{urn:oasis:names:tc:SAML:2.0:ac:classes:Password}WrittenConsent"] = (
        "written_consent",
        WrittenConsent,
    )
...
class SecurityAuditType_(SamlBase):
    ...
    c_child_order = SamlBase.c_child_order[:]
    c_cardinality = SamlBase.c_cardinality.copy()
    c_children["{urn:oasis:names:tc:SAML:2.0:ac:classes:Password}SwitchAudit"] = (
        "switch_audit",
        SwitchAudit,
    )
...
class OperationalProtectionType_(SamlBase):
    ...
    c_child_order = SamlBase.c_child_order[:]
    c_cardinality = SamlBase.c_cardinality.copy()
    c_children["{urn:oasis:names:tc:SAML:2.0:ac:classes:Password}SecurityAudit"] = (
        "security_audit",
        SecurityAudit,
    )
...
class PrincipalAuthenticationMechanismType_(SamlBase):
    ...
    c_children["{urn:oasis:names:tc:SAML:2.0:ac:classes:Password}ActivationPin"] = (
        "activation_pin",
        ActivationPin,
    )
...
class PrivateKeyProtectionType_(SamlBase):
    ...
    c_child_order = SamlBase.c_child_order[:]
    c_cardinality = SamlBase.c_cardinality.copy()
    c_children["{urn:oasis:names:tc:SAML:2.0:ac:classes:Password}KeyActivation"] = (
        "key_activation",
        KeyActivation,
    )
    c_cardinality["key_activation"] = {"min": 0, "max": 1}
    c_children["{urn:oasis:names:tc:SAML:2.0:ac:classes:Password}KeyStorage"] = (
        "key_storage",
        KeyStorage,
    )
    c_cardinality["key_storage"] = {"min": 0, "max": 1}
    c_children["{urn:oasis:names:tc:SAML:2.0:ac:classes:Password}KeySharing"] = (
        "key_sharing",
        KeySharing,
    )
...
class AuthnMethodBaseType_(SamlBase):
    ...
    c_children["{urn:oasis:names:tc:SAML:2.0:ac:classes:Password}Authenticator"] = (
        "authenticator",
        Authenticator,
    )
    c_children[
...
class AuthnContextDeclarationBaseType_(SamlBase):
    ...
    c_child_order = SamlBase.c_child_order[:]
    c_cardinality = SamlBase.c_cardinality.copy()
    c_children["{urn:oasis:names:tc:SAML:2.0:ac:classes:Password}Identification"] = (
        "identification",
        Identification,
    )
    ...
    c_children["{urn:oasis:names:tc:SAML:2.0:ac:classes:Password}AuthnMethod"] = (
        "authn_method",
        AuthnMethod,
    )
    c_children[
...
class ComplexAuthenticatorType_(SamlBase):
    ...
    c_children["{urn:oasis:names:tc:SAML:2.0:ac:classes:Password}ResumeSession"] = (
        "resume_session",
        ResumeSession,
    )
    ...
    c_cardinality["restricted_password"] = {"min": 0, "max": 1}
    c_children["{urn:oasis:names:tc:SAML:2.0:ac:classes:Password}ZeroKnowledge"] = (
        "zero_knowledge",
        ZeroKnowledge,
    )
    ...
    c_children["{urn:oasis:names:tc:SAML:2.0:ac:classes:Password}UserSuffix"] = (
        "user_suffix",
        UserSuffix,
    )
